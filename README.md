...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22179171.svg)](https://doi.org/10.5281/zenodo.22179171)
...
A curated collection of **53 foundational papers** with structured metadata and arXiv links, organized in [`papers/`](papers/PAPERS.md):
...
| 🌉 Sim2Real & RL | 7 | Domain Randomization, Teacher-Student, RMA, ANYmal, GNN cable |
| ⚙️ Robotics Frameworks | 1 | ROS 2 design and architecture (Macenski et al.) |
...
| [`papers.csv`](papers.csv) | Structured metadata (53 rows): arXiv, year, robot type, model, ROS integration, latency, code availability |
